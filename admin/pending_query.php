        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12 lg-12 sm-12">
              ...
              <h1 class="page-title" style="font-size: 40px; font-weight: 600; color: #870909;">Pending Query</h1>
                ...
                <tbody>
                  ...
                  while ($row = mysqli_fetch_assoc($result)) { ?>
                    <tr>
                      ...
                      <?php } ?>
                      <td id="he" style="width:100px; padding:10px;">
                        <a style="background-color:#c81e1e; color:white; padding:5px; border-radius: 5px; " href='delete_query.php?id=<?php echo $row['query_id']; ?>'> Delete </a>
                      </td>
                    </tr>
                  <?php } ?>
                </tbody>
