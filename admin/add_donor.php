        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12 lg-12 sm-12">
              ...
              <h1 class="page-title" style="font-size: 40px; font-weight: 600; color: #870909;">Add Donor</h1>
            </div>
          </div>
          <hr>
          <form name="donor" action="save_donor_data.php" method="post">
            ...
            <div class="row">
              <div class="col-lg-4 mb-4">
                <div><input type="submit" name="submit" class="btn btn-danger" value="Submit" style="cursor:pointer" onclick="popup()"></div>
              </div>
            </div>
          </form>
