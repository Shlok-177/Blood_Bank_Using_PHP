        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12 lg-12 sm-12">
              ...
              <h1 class="page-title" style="font-size: 40px; font-weight: 600; color: #870909;">Donor List</h1>
                ...
                <tbody>
                  ...
                  while ($row = mysqli_fetch_assoc($result)) { ?>
                    <tr>
                      ...
                      <td id="he" style="width:100px; padding: 12px 0px;">
                        <a style="background-color:#c81e1e; color:white; padding:5px; border-radius: 5px; " href='delete.php?id=<?php echo $row['donor_id']; ?>'> Delete </a>
                      </td>
                    </tr>
                  <?php } ?>
                </tbody>
          ...
          <div class="table-responsive" style="text-align:center;align:center">
            ...
            if (mysqli_num_rows($result1) > 0) {
              ...
              if ($page > 1) {
                echo '<li><a href="donor_list.php?page=' . ($page - 1) . '"  style = "background-color: #c81e1e;color: white;">Prev</a></li>';
              }
              ...
              if ($total_page > $page) {
                echo '<li><a href="donor_list.php?page=' . ($page + 1) . '"   style = "background-color:#c81e1e;color: white;">Next</a></li>';
              }
